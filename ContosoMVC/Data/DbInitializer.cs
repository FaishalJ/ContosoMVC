...
namespace ContosoMVC.Data
{
    public static class DbInitializer
    {
        ...
        // 2. instructors
        public static Instructor[] SeedInstructors() =>
        [
        ...
        // 3. departments
        public static Department[] SeedDepartments(List<Instructor> instructors) =>
        [
        ...
        // 4. courses
        public static Course[] SeedCourses(List<Department> departments) =>
        [
        ...
        public static OfficeAssignment[] SeedOfficeAssignments(List<Instructor> instructors) =>
        [
            new() {
                InstructorID = instructors.Single( i => i.LastName == "Fakhouri").ID,
                Location = "Smith 17" },
        ...
        // 6. enrollments
        public static Enrollment[] SeedEnrollments(List<Student> students, List<Course> courses) =>
        [
            new() {
        ...
        public static CourseAssignment[] SeedCourseAssignments(List<Course> courses, List<Instructor> instructors) =>
        [
            new() {
                CourseID = courses.Single(c => c.Title == "Chemistry" ).CourseID,
                InstructorID = instructors.Single(i => i.LastName == "Kapoor").ID
